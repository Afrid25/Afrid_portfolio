...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Admin access - Press Ctrl+Shift+A to open admin panel
    ...
    // Add a subtle admin link in the footer (you can remove this if you want it completely hidden)
    const footer = document.createElement('div');
    footer.innerHTML = '<p style="text-align: center; font-size: 0.8rem; margin-top: 2rem; opacity: 0.5;">Press Ctrl+Shift+A for admin access</p>';
    document.querySelector('#contact .contact-content').appendChild(footer);
});
